      ...
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-10">
          ...
          <div className="space-y-6">
            <div
              className={`flex items-center gap-4 p-6 bg-slate-900/50 backdrop-blur-lg rounded-2xl border border-slate-800 transition-all duration-500 hover:border-purple-500 hover:shadow-lg`}
            >
              ...
              <div>
                ...
                <div className="flex gap-4 mt-1">
                  <a
                    ...
                    className="text-slate-400 hover:text-purple-400 transition-transform hover:scale-110"
                  >
                    <Github size={24} />
                  </a>
                  <a
        ...
        <div
          className={`space-y-4 p-6 bg-slate-900/50 backdrop-blur-lg rounded-2xl border border-slate-800 transition-all duration-500`}
        >
          <input
            type="text"
            name="firstName"
          ...
          <button
            onClick={() =>
              (window.location.href = `https://formsubmit.co/8e0862922f3402a25639bcc38f5a6b58`)
            }
